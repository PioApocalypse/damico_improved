...
== Istruzione
[#ingmec]
=== _Dottore Triennale in Ingegneria Meccanica_, laureato presso l'Università degli Studi di Salerno
* Immatricolato nell'A.A. 2017/2018.
* Laureato con voto finale di 97/110 e media ponderata pari a 24.8/30.
* Titolo tesi: _Simulazione di una turbina eolica off-grid_.
...
=== Hard skill
  * #Conoscenze di ingegneria meccanica#
    ** Già descritte nella link:#ingmec[sezione dedicata].

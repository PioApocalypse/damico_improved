...
* "*DIGITAL MANUFACTURING - Prototipazione 3D e CNC*" (24/06/2021 - 06/08/2021) - cod. prog. Formatemp "094 PROT D211 1983".
  ...
  ** Organizzato da EDESIA s.r.l. / WINTIME s.p.a. (Napoli). link:/documenti/università/digital_manufacturing_P21WT036.pdf[Attestato di frequenza., window=_blank]
* "*Corso di Formazione Generale per i Lavoratori*" (06/07/2021) - cod. att. (link:https://opnitalialavoro.it/verifica-dellautenticita/[137413_5/15, title="Verifica autenticità", window=_blank]). link:/documenti/università/Sicurezza_sul_Lavoro_P21WT036.pdf[Attestato di superamento., window=_blank]
